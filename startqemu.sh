...
qemu-system-x86_64 -machine q35 -m 6144 -smp cpus=8 -cpu qemu64 \
  ...
  -netdev user,id=n1,net=192.168.50.0/24,hostfwd=tcp::9000-:9000,hostfwd=tcp::8080-:8080,hostfwd=tcp::4433-:443,hostfwd=tcp::8081-:80,hostfwd=tcp::9100-:9100,hostfwd=tcp::2222-:22 \
